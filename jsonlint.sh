...
###
print_usage() {
	>&2 echo "Usage: troyfontaine/swiss_linter json [-sti] <PATH-TO-FILE>"
	>&2 echo "       troyfontaine/swiss_linter json [-sti] <GLOB-PATTERN>"
	>&2 echo "       troyfontaine/swiss_linter json --version"
	>&2 echo "       troyfontaine/swiss_linter json --help"
	>&2 echo
...
_jsonlint() {
	...
	local ret=0
	local cmd="jsonlint -c -q ${args} ${file}"
